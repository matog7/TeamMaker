...
INSERT INTO
    formations (id, name, description)
VALUES (
        '442',
        '4-4-2',
        'Formation classique avec 4 défenseurs, 4 milieux et 2 attaquants'
    ),
    (
        '433',
        '4-3-3',
        'Formation offensive avec 4 défenseurs, 3 milieux et 3 attaquants'
    ),
    (
        '41212',
        '4-1-2-1-2',
        'Formation en losange avec 4 défenseurs, 1 milieu défensif, 2 milieux latéraux, 1 milieu offensif et 2 attaquants'
    ),
    (
        '352',
        '3-5-2',
        'Formation avec 3 défenseurs, 5 milieux et 2 attaquants'
    ),
    (
        '532',
        '5-3-2',
        'Formation défensive avec 5 défenseurs, 3 milieux et 2 attaquants'
    ),
    (
        '451',
        '4-5-1',
        'Formation avec 4 défenseurs, 5 milieux et 1 attaquant'
    ),
    (
        '541',
        '5-4-1',
        'Formation avec 5 défenseurs, 4 milieux et 1 attaquant'
    ),
    (
        '4321',
        '4-3-2-1',
        'Formation avec 4 défenseurs, 3 milieux, 2 milieux défensifs et 1 attaquant'
    ),
    (
        '523',
        '5-2-3',
        'Formation avec 5 défenseurs, 2 milieux et 3 attaquants'
    ),
    (
        '4231',
        '4-2-3-1',
        'Formation avec 4 défenseurs, 2 milieux, 3 milieux défensifs et 1 attaquant'
    ),
    (
        '5122',
        '5-1-2-2',
        'Formation avec 5 défenseurs, 1 milieu, 2 milieux défensifs et 2 attaquants'
    ),
    (
        '4132',
        '4-1-3-2',
        'Formation avec 4 défenseurs, 1 milieu, 3 milieux défensifs et 2 attaquants'
    ),
    (
        '343',
        '3-4-3',
        'Formation avec 3 défenseurs, 4 milieux et 3 attaquants'
...
VALUES ('442', 1, 50.00, 90.00, 'GK'), -- Gardien
...
VALUES ('433', 1, 50.00, 90.00, 'GK'), -- Gardien
...
VALUES ('352', 1, 50.00, 90.00, 'GK'), -- Gardien
...
VALUES ('532', 1, 50.00, 90.00, 'GK'), -- Gardien
...
INSERT INTO
    teams (name, formation_id)
VALUES ('Équipe de France', '433'),
    ('Real Madrid', '442'),
    ('Manchester City', '41212') ON CONFLICT DO NOTHING;
